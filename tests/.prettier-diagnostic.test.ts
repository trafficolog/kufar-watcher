...
const targets = [
  'electron/worker/kufar-embedded-search-state.ts',
  'tests/unit/kufar-embedded-search-state.test.ts',
]

it('prints exact prettier output for embedded search-state files', async () => {
