...
| `2.7` | [Ремедиация повторного аудита фазы 2](../epics/2-7-phase2-audit-remediation.md) | ✅ done | 🟢 aligned | 12/12 done: remediation фазы 2 закрыта; Run startup recovery теперь подтверждает orphan ownership через canonical per-monitor advisory lease. |
