...
| `2.7` | [Ремедиация повторного аудита фазы 2](../epics/2-7-phase2-audit-remediation.md) | 🔄 in_progress | 🟡 drifted | 11/12 done: 2.7.12 усиливает Run startup recovery process-safe ownership proof через canonical per-monitor advisory lease. |
