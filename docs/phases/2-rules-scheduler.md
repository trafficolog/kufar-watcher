...
**Эпиков:** 6 · **done:** 0 · **в работе/план:** 6

| ID | Эпик | Статус | Sync | Ист. |
|----|------|--------|------|------|
| `2.1` | [Нормализация текста и glob-маски](../epics/2-1-morphology-globs.md) | ⬜ todo | 🟡 drifted | Нормализация текста и glob-маски — входит в срез MVP-1. |
| `2.2` | [Матчер ключевых слов](../epics/2-2-matcher.md) | ⬜ todo | 🟡 drifted | Отбор объявлений по ключевым словам. |
