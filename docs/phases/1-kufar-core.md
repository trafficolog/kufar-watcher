...
status_note: "Фаза 1 закрыта: все 6 эпиков (1.0–1.5) done/aligned; HTTP remediation 1.2.5 добавила terminal response journaling без изменения retry/cooldown policy."
---
...
| `1.2` | [HTTP-клиент и лимитер](../epics/1-2-http-client.md) | ✅ done | 🟢 aligned | 5/5 done: global limiter, resilient HTTP client, raw-response journal, stable application-level User-Agent and terminal HTTP response journaling are implemented and verified; 1.2.5 RED #1432 / GREEN #1434. |
