...
| `1.3` | [Адаптеры выдачи Kufar](../epics/1-3-source-adapters.md) | 🔄 in_progress | 🟢 aligned | 3/4: общий SourceAdapter, electronics и real-estate adapters готовы; HTML fallback впереди. |
