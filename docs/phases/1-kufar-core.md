...
| `1.3` | [Адаптеры выдачи Kufar](../epics/1-3-source-adapters.md) | 🔄 in_progress | 🟢 aligned | 2/4: общий SourceAdapter и electronics adapter готовы; real estate и HTML fallback впереди. |
