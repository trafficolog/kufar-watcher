...
| `1.3` | [Адаптеры выдачи Kufar](../epics/1-3-source-adapters.md) | ✅ done | 🟢 aligned | 4/4: общий SourceAdapter, electronics, real-estate и проверенный HTML fallback готовы. |
