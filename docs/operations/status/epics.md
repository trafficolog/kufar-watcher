...
| `2.7` | Ремедиация повторного аудита фазы 2 | 2 | 🔄 in_progress | 🟡 drifted | P0/P1 remediation закрыта: 2.7.1–2.7.6 и 2.7.11 done; остаются P2 2.7.7/2.7.9 и измерительный P3 2.7.8. |
