...
| `1.1` | URL-парсер и canonical query | 1 | ⬜ todo | 🟡 drifted | Единственная точка входа пользователя — ссылка. |
| `1.2` | HTTP-клиент и лимитер | 1 | ⬜ todo | 🟡 drifted | Вежливый и предсказуемый сетевой слой. |
| `1.3` | Адаптеры выдачи Kufar | 1 | ⬜ todo | 🟡 drifted | Нормализация выдачи двух категорий. |
...
| `2.1` | Нормализация текста и glob-маски | 2 | ⬜ todo | 🟡 drifted | Нормализация текста и glob-маски — входит в срез MVP-1. |
| `2.2` | Матчер ключевых слов | 2 | ⬜ todo | 🟡 drifted | Отбор объявлений по ключевым словам. |
| `2.3` | Фильтр продавца | 2 | ⬜ todo | 🟡 drifted | Исключение нежелательных продавцов. |
| `2.4` | Планировщик на pg-boss | 2 | ⬜ todo | 🟡 drifted | Персональные интервалы обхода. |
