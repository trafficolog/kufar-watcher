...
| `2.7` | Ремедиация повторного аудита фазы 2 | 2 | ✅ done | 🟢 aligned | 10/10 done: P0/P1/P2 remediation реализована; P3 2.7.8 закрыта measurement-only — global limiter достаточно подавляет внешний burst, scheduler stagger не требуется; Phase 5 gate 5.2.4 сохранён. |
| `3.1` | Телеграм-бот и транспорт | 3 | 🔄 in_progress | 🟡 drifted | 3.1.1 bot bootstrap и безопасная привязка чата завершены; reconnect и outbox остаются в 3.1.2–3.1.3. |
