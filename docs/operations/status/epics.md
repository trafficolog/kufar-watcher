...
| `2.4` | Планировщик на pg-boss | 2 | ⬜ todo | 🟡 drifted | Персональные интервалы, no-overlap и Run journal закрыты: 2.4.1–2.4.3 done, 3/4 задач; далее retries и деградация. |
