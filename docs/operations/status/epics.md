...
| `1.2` | HTTP-клиент и лимитер | 1 | 🔄 in_progress | 🟢 aligned | 4/5 done: global limiter, resilient HTTP client, raw-response journal and stable application-level User-Agent are implemented; 1.2.5 terminal HTTP response journaling is in TDD after RED verify #1432. |
