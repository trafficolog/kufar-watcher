...
export type WorkerControlMessage =
  ...
  | { type: 'telegram-verify-token'; requestId: string; token: string }
...
export type WorkerEvent =
  ...
  | { type: 'telegram-verify-token-result'; requestId: string; username: string }
  ...
  | { type: 'telegram-test-message-result'; requestId: string }
  | { type: 'telegram-test-message-error'; requestId: string }
