  ...
  <div class="first-run-shell">
    ...
    <main class="first-run-main">
      ...
      <section class="intro">
        ...
        <p class="lede">
          Инфраструктура уже поднята. До первого уведомления осталось два шага: настроить
          Telegram и создать первое правило мониторинга.
        </p>
      </section>
      ...
      <section class="steps" aria-label="Шаги первого запуска">
        <article class="step-card" :class="{ complete: telegramConfigured }">
          ...
          <div class="step-body">
            ...
            <p>
              Добавьте токен бота и привяжите чат. Идентификатор чата искать вручную не
              нужно — приложение найдёт его после сообщения боту.
            </p>
        ...
        <article class="step-card">
          ...
          <div class="step-body">
            ...
            <p>
              Вставьте ссылку на нужную выдачу Kufar, задайте интервал и ключевые слова.
              Первый обход не пришлёт уведомлений: он только запомнит текущую выдачу как
              точку отсчёта.
            </p>
      ...
      <aside class="note">
        ...
        <p>
          После появления первого правила главная приведёт вас в список мониторов. Избранное
          и Архив до первых находок остаются пустыми — это нормальное состояние новой базы.
        </p>
      </aside>
    </main>
  </div>
