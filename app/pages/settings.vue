  ...
  <main class="telegram-settings">
    ...
    <section class="panel" aria-labelledby="telegram-token-title">
      ...
      <div v-if="consentRequired" class="warning" role="alert">
        ...
        <p>
          Токен будет сохранён локально без реального шифрования. Продолжайте только если понимаете
          этот риск; приложение не будет называть такое хранение защищённым.
        </p>
        <div class="actions">
          <button
            class="button danger"
